  ...
  return (
    <main className="w-full min-h-screen bg-slate-50 pt-[120px] pb-20 font-sans">
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-white p-8 md:p-12 shadow-sm border-b-4 border-[#0C5588] mb-12">
        ...
        <div className="grid gap-6">
          {sections.map((section, idx) => (
            <motion.div key={idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }}
              className="bg-white p-8 flex gap-6 items-start shadow-sm border-l-4 border-slate-200 hover:border-[#16AFD1] transition-all">
